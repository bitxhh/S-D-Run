...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption('Super Duper Pirate Run')
        ...
        self.current_stage = Level(self.display, self.tmx_maps[self.data.current_level], self.level_frames, self.data, self.switch_stage, self.audio_files)
        self.bg_music.set_volume(0.1)
        self.bg_music.play(-1)

    def switch_stage(self, target, unlock=0):
        if target == 'level':
            self.current_stage = Level(self.display, self.tmx_maps[self.data.current_level], self.level_frames,
