...
from sprite import Sprite, Cloud
...
class AllSprites(pygame.sprite.Group):
    ...
    def draw_sky(self):
        ...
        pygame.draw.line(self.display_surface, '#f5f1de', (0,horizon_pos), (self.width, horizon_pos), 3)
    ...
    def draw_large_cloud(self, dt):
        ...
        for cloud in range(self.large_cloud_tiles):
            left=self.large_cloud_x + self.large_cloud_width * cloud + self.offset.x * dt
